...
describe('Address', function() {
  ...
  var str = 'DGQo5RxDHTcUppo5yUrp62goBaaaWomaxm';
  ...
  // livenet valid
  var PKHLivenet = [
    'DTjnS62PJTpDdEgrKnwrSbjkwGhpaCTjFS',
    'DMwAWwTHouFagYffAv1Lou7YE3gSg3Mnas',
    'DAAKr8qrDVS7d68Lk7etHbPfUDQVuVJ2z6',
    'DLgrHsDCiyG5Tu6twtpDE1m6iE4cxM7AAo',
    '    D6EopZmLLf68Qz4C6CUHG3WgVqdHK4eFQY   \t\n'
  ];
  ...
  describe('validation', function() {
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('DMwAWwTHouFagYffAv1Lou7YE3gSg3Mnas');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      var pubkey = new PublicKey('02671F3A6F94B3AA8FAD92FDFAD5F1DB0B4FB404611D2E66668F8F223DF964B428');
      var address = Address.fromPublicKey(pubkey, 'livenet');
      address.toString().should.equal('DTjnS62PJTpDdEgrKnwrSbjkwGhpaCTjFS');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      var pubkey = new PublicKey('04671F3A6F94B3AA8FAD92FDFAD5F1DB0B4FB404611D2E66668F8F223DF964B42' +
        '81CE116044B160C77F73AFEECAE5A0279584377EE532530184B76D38BA54041CA');
      var a = Address.fromPublicKey(pubkey, 'livenet');
      a.toString().should.equal('DTjnS62PJTpDdEgrKnwrSbjkwGhpaCTjFS');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('DTjnS62PJTpDdEgrKnwrSbjkwGhpaCTjFS');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('DLgrHsDCiyG5Tu6twtpDE1m6iE4cxM7AAo');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('DLgrHsDCiyG5Tu6twtpDE1m6iE4cxM7AAo');
      });
      ...
      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'D6EopZmLLf68Qz4C6CUHG3WgVqdHK4eFQY';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash D6EopZmLLf68Qz4C6CUHG3WgVqdHK4eFQY', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: DAAKr8qrDVS7d68Lk7etHbPfUDQVuVJ2z6, type: pubkeyhash, network: livenet>';
