...
describe('PrivateKey', function() {
  ...
  it('should create a private key from WIF string', function() {
    var a = new PrivateKey('6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia');
    should.exist(a);
    should.exist(a.bn);
  });

  it('should create a private key from WIF buffer', function() {
    var a = new PrivateKey(Base58Check.decode('6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia'));
    should.exist(a);
    should.exist(a.bn);
  });
  ...
  describe('instantiation', function() {
    ...
    it('should not be able to instantiate private key because of network mismatch', function() {
      expect(function() {
        return new PrivateKey('6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia', 'testnet');
      }).to.throw('Private key network mismatch');
    });

    it('should not be able to instantiate private key WIF is too long', function() {
      expect(function() {
        var buf = Base58Check.decode('6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia');
  ...
  describe('#toAddress', function() {
    it('should output this known livenet address correctly', function() {
      var privkey = PrivateKey.fromWIF('6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia');
      var address = privkey.toAddress();
      address.toString().should.equal('DMwAWwTHouFagYffAv1Lou7YE3gSg3Mnas');
    });
  ...
  describe('#getValidationError', function(){
    ...
    it('should validate as true', function() {
      var a = PrivateKey.isValid('6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia');
      a.should.equal(true);
    });
  ...
  describe('#toPublicKey', function() {
    ...
    it('should convert this known PrivateKey to known PublicKey and preserve compressed=true', function() {
      var privwif = '6Jks4jStWpWxvCRJGevSF23yZvBC3Xt7upQiQj7mSWomLXpTPia';
